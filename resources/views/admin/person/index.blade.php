                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'firt_name'">{{ trans('admin.person.columns.firt_name') }}</th>
                                        <th is='sortable' :column="'last_name'">{{ trans('admin.person.columns.last_name') }}</th>
                                        <th is='sortable' :column="'identification'">{{ trans('admin.person.columns.identification') }}</th>
                                        <th is='sortable' :column="'email'">{{ trans('admin.person.columns.email') }}</th>
                                        <th is='sortable' :column="'telephone'">{{ trans('admin.person.columns.telephone') }}</th>
                                        <th is='sortable' :column="'address'">{{ trans('admin.person.columns.address') }}</th>
                                        <th is='sortable' :column="'birthday'">{{ trans('admin.person.columns.birthday') }}</th>
                                        <th is='sortable' :column="'gender'">{{ trans('admin.person.columns.gender') }}</th>
                                        <th is='sortable' :column="'id_cities'">{{ trans('admin.person.columns.id_cities') }}</th>
