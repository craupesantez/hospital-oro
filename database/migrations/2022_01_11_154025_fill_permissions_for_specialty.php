...
class FillPermissionsForSpecialty extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpecialty constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.specialty',
            'admin.specialty.index',
            'admin.specialty.create',
            'admin.specialty.show',
            'admin.specialty.edit',
            'admin.specialty.delete',
            'admin.specialty.bulk-delete',
        ]);
