...
class FillPermissionsForSpecialist extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSpecialist constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.specialist',
            'admin.specialist.index',
            'admin.specialist.create',
            'admin.specialist.show',
            'admin.specialist.edit',
            'admin.specialist.delete',
            'admin.specialist.bulk-delete',
        ]);
