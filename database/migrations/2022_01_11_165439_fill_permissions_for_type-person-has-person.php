...
class FillPermissionsForTypePersonHasPerson extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypePersonHasPerson constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-person-has-person',
            'admin.type-person-has-person.index',
            'admin.type-person-has-person.create',
            'admin.type-person-has-person.show',
            'admin.type-person-has-person.edit',
            'admin.type-person-has-person.delete',
            'admin.type-person-has-person.bulk-delete',
        ]);
