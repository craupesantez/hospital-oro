...
class FillPermissionsForTypesOfPerson extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypesOfPerson constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.types-of-person',
            'admin.types-of-person.index',
            'admin.types-of-person.create',
            'admin.types-of-person.show',
            'admin.types-of-person.edit',
            'admin.types-of-person.delete',
            'admin.types-of-person.bulk-delete',
        ]);
